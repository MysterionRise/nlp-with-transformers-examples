...
def batch_evaluate(
    ...
    # Reorder columns
    cols = ["model", "candidate", "BLEU", "ROUGE-1", "ROUGE-2", "ROUGE-L", "METEOR", "BERTScore F1"]
...
# Example texts
EXAMPLE_REFERENCE = """The investment strategy involves diversifying assets across various sectors to mitigate risks and maximize returns. This approach ensures a balanced portfolio that can withstand market volatility while providing steady growth opportunities."""

EXAMPLE_CANDIDATE_1 = """The strategy for investments involves diversifying assets across multiple sectors to minimize risks and optimize returns. This method ensures a balanced portfolio that can handle market fluctuations while offering consistent growth opportunities."""

EXAMPLE_CANDIDATE_2 = """An investment approach focuses on spreading assets across different sectors to reduce risk and increase profits. This strategy creates a stable portfolio resistant to market changes and provides continuous growth potential."""

EXAMPLE_CANDIDATE_3 = """The financial plan includes asset diversification across various industries to lower risks and enhance returns. This ensures portfolio balance and resilience against market volatility with sustainable growth prospects."""
        ...
        with gr.Tabs():
            ...
            with gr.Tab("Batch Comparison"):
                ...
                batch_ref = gr.Textbox(
                    label="Reference Text", lines=4, value=EXAMPLE_REFERENCE, placeholder="Enter reference text..."
                )
